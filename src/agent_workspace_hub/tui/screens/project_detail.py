...
class ProjectDetailScreen(Screen):
    ...
    def on_mount(self) -> None:
        self.query_one(DataTable, id="tasks-table").add_columns("ID", "Title", "Status", "Priority", "Assigned")
        self.query_one(DataTable, id="memory-table").add_columns("Time", "Type", "Agent", "Message")
        self._load_all()
    ...
    def _load_tasks(self) -> None:
        t = self.query_one(DataTable, id="tasks-table")
        t.clear()
        try:
    ...
    def _load_memory(self) -> None:
        t = self.query_one(DataTable, id="memory-table")
        t.clear()
        try:
